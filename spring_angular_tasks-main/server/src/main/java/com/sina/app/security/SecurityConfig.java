...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        // -- Allow only admins & LoggedUsers to get the list of tasks
        ...
        http.authorizeRequests().antMatchers(HttpMethod.PUT, "/tasks/**").hasAnyAuthority("ADMIN");
        http.authorizeRequests().antMatchers(HttpMethod.DELETE, "/tasks/**").hasAnyAuthority("ADMIN");
